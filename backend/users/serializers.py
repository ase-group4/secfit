...
class RememberMeSerializer(serializers.ModelSerializer):
    """Serializer for a RememberMe cookie.

    Serialized fields: remember_me

    Attributes:
        remember_me:    Value of cookie used for remember_me functionality
    """

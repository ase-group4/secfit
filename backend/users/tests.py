...
class TestUserSerializer(TestCase):
    ...
    def test_contains_expected_fields(self):
        """ Tests that all expected data fields are present after using the UserSerializer()-function. """
        data = self.serializer.data
        self.assertEqual(set(data.keys()), set(['url', 'id', 'email', 'username', 'athletes', 'phone_number', 'country', 'city', 'street_address', 'coach', 'workouts', 'coach_files', 'athlete_files']))

...
const emails = [chance.email(), chance.string({ length: 245, pool: "abcd" })+"@gmail.com",  'notanemail']
...
const  combinations= {1:[0,0,0,0,0,0,0,0],
                    810:[1,1,1,1,1,1,1,0],
                    431:[2,2,1,1,0,0,0,1],
                    732:[3,2,0,0,1,1,1,1],
                    390:[1,1,0,0,0,0,0,1],
...
describe("Register page 2-way domain tests", () => {
    ...
    function testUsernameFail(value){
        ...
        */
        ...
        cy.get(".alert").contains("username").then((textAlert) =>{
            if (value ==1){
                cy.expect(textAlert[0].outerText).to.equal("username\nEnsure this field has no more than 150 characters.")
            } else if (value ==2){
                cy.expect(textAlert[0].outerText).to.equal("Enter a valid username. This value may contain only letters, numbers, and @/./+/-/_ characters.")
            } else if (value ==3){
    ...
    function testEmailFail(value){
        ...
        */
        ...
        cy.get(".alert").contains("email").then((textAlert) =>{
            if (value ==1){
                cy.expect(textAlert[0].outerText).to.equal("email\nEnsure this field has no more than 254 characters.")
            } else if (value ==2){
    ...
    function testPasswordFail(value){
        ...
        */
        ...
        cy.get(".alert").contains("password").then((textAlert) =>{
    ...
    function testPassword1Fail(value){
        ...
        */
        ...
        cy.get(".alert").contains("password1").then((textAlert) =>{
            console.log(textAlert)
            cy.expect(value).to.equal(1)
    ...
    function testPhoneFail(value){
        ...
        */
        ...
        cy.get(".alert").contains("phone_number").then((textAlert) =>{
            cy.expect(value).to.equal(1)
            cy.expect(textAlert[0].outerText).to.equal("phone_number\nEnsure this field has no more than 50 characters.")
        })
    };
    ...
    function testCountryFail(value){
        ...
        */
        ...
        cy.get(".alert").contains("country").then((textAlert) =>{
            cy.expect(value).to.equal(1)
            cy.expect(textAlert[0].outerText).to.equal("country\nEnsure this field has no more than 50 characters.")
        })
    };
    ...
    function testCityFail(value){
        ...
        */
        ...
        cy.get(".alert").contains("city").then((textAlert) =>{
            cy.expect(value).to.equal(1)
            cy.expect(textAlert[0].outerText).to.equal("city\nEnsure this field has no more than 50 characters.")
        })
    };
    ...
    function testAddressFail(value){
        ...
        */
        ...
        cy.get(".alert").contains("street_address").then((textAlert) =>{
            cy.expect(value).to.equal(1)
            cy.expect(textAlert[0].outerText).to.equal("street_address\nEnsure this field has no more than 50 characters.")
        })
    };
    ...
    for (let [key, value] of Object.entries(combinations)){
        // loops through each combination to acieve 2-way testing
